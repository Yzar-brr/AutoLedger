            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            <div>
                                ...
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    L'accès à ce site web est restreint, afin d'obtenir des identifiants, veuillez remplir le formulaire d'enregistrement.
                                </p>
                            </div>
                    </div>
                </div>
                ...
                <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                    ...
                    <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-end sm:ms-0">
                        2025 © Nextway - Sofiane WIBAUT. All rights reserved.
                    </div>
                </div>
            </div>
        </div>
